...
function _FontList({
  ...
  const [filteredFontFamilies, setFilteredFontFamilies] = useState(
    fontFamilies
  );
          ...
          <TextField
            ...
            onChange={(event: any) => {
              ...
              if (value === "") {
                ...
                setFilteredFontFamilies(
                  fontFamilies.filter((family: any) => {
...
function GoogleFontPicker({
  ...
  const [currentFont, setCurrentFont] = useState<string | null | undefined>(
    null
  );
      ...
      <Grid container alignItems="center">
        ...
        <div
          onClick={(event: any) => {
            ...
            setfFname(currentFont);
          }}
          style={{
            fontFamily: currentFont || "sans-serif"
          }}
        >
          <div className="RightSideBar2__Text">
            <div className="RightSideBar2__Btn">
              <h2 className="RightSideBar2__Btn__title"> {currentFont} </h2>{" "}
